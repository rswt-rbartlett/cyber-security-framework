...
In addition to the standard set out below a [Maturity Model](/Levels/README.md#introduction) which sets out the measures Trusts should take in meeting this standard dependent on the scope of their information systems and the resultant risks.

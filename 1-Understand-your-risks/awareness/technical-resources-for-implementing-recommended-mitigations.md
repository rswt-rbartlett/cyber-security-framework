...
This document accompanies the “Cyber threats and recommended mitigations” paper previously posted to Wildnet, and provides some technical background on;
...
1.2. Manage Windows servers updates using WSUS (for on-premises infrastructure) and/or Azure Update Management (for on-premises and cloud hosts). 1.3. Sign up to NCSC ACD Early Warning (https://www.ncsc.gov.uk/section/active-cyber-defence/introduction) to monitor your perimeter, they will warn you of exposed ports and particularly vulnerable exposed services.
